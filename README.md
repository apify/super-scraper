...
The Standby Crawler serves as a seamless and direct replacement for [ScrapingBee's](https://www.scrapingbee.com/documentation/) and [ScrapingAnt's](https://docs.scrapingant.com/request-response-format#available-parameters) API on the Apify platform.
